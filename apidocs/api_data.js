define({ "api": [
  ...
  },
  {
    ...
    "group": "Categorias",
    "version": "1.0.0",
    "description": "<p>Obtiene un listado de todas las categorias</p>",
    "examples": [
      {
        "title": "Ejemplo de uso:",
        "content": "fetch(\"https://preguntadas.herokuapp.com/v1/categories/all\", {\n     headers: {\n         \"Authorization\": \"eyJpc3MiOiJ0b3B0YWwuY29tIiwiZXhwIjoxNDI2NDIwODAwLCJodHRwOi8vdG9wdGFsLmNvbS9qd3RfY2xhaW1zL2lzX2FkbWluIjp0cnVlLCJjb21wYW55IjoiVG9wdGFsIiwiYXdlc29tZSI6dHJ1ZX0\"\n     },\n     method: \"get\",\n}).then(function(result) {\n     return result.json();\n}).then(function(result) {\n\n}).catch(function(error) {\n\n});",
        "type": "js"
      }
    ],
    "parameter": {
  ...
  {
    "type": "get",
    "url": "/v1/notifications/:quantity?/:page?",
    ...
    "examples": [
      {
        "title": "Ejemplo de uso:",
        "content": "fetch(\"https://preguntadas.herokuapp.com/v1/notifications/10\", {\n     headers: {\n         \"Authorization\": \"eyJpc3MiOiJ0b3B0YWwuY29tIiwiZXhwIjoxNDI2NDIwODAwLCJodHRwOi8vdG9wdGFsLmNvbS9qd3RfY2xhaW1zL2lzX2FkbWluIjp0cnVlLCJjb21wYW55IjoiVG9wdGFsIiwiYXdlc29tZSI6dHJ1ZX0\"\n     },\n     method: \"get\",\n}).then(function(result) {\n     return result.json();\n}).then(function(result) {\n\n}).catch(function(error) {\n\n});",
        "type": "js"
      }
    ],
    "parameter": {
  ...
  {
    "type": "get",
    "url": "/v1/challenges/ranking/:sort?/:page?",
    "title": "Obtener rankings de desafios",
    ...
    "description": "<p>Obtiene el ranking de todos los desafíos</p>",
    "examples": [
      {
        "title": "Ejemplo de uso:",
        "content": "fetch(\"https://preguntadas.herokuapp.com/v1/challenges/ranking/top\", {\n     headers: {\n         \"Authorization\": \"eyJpc3MiOiJ0b3B0YWwuY29tIiwiZXhwIjoxNDI2NDIwODAwLCJodHRwOi8vdG9wdGFsLmNvbS9qd3RfY2xhaW1zL2lzX2FkbWluIjp0cnVlLCJjb21wYW55IjoiVG9wdGFsIiwiYXdlc29tZSI6dHJ1ZX0\"\n     },\n     method: \"get\",\n}).then(function(result) {\n     return result.json();\n}).then(function(result) {\n\n}).catch(function(error) {\n\n});",
        "type": "js"
      }
    ],
    "parameter": {
  ...
  {
    "type": "get",
    "url": "/v1/categories/ranking/:sort?",
    "title": "Obtener rankings de categorias",
    "name": "getcategories",
    "group": "Rankings",
    "version": "1.0.0",
    "description": "<p>Obtiene el ranking de todas las categorias</p>",
    "examples": [
      {
        "title": "Ejemplo de uso:",
        "content": "fetch(\"https://preguntadas.herokuapp.com/v1/categories/ranking/likes\", {\n     headers: {\n         \"Authorization\": \"eyJpc3MiOiJ0b3B0YWwuY29tIiwiZXhwIjoxNDI2NDIwODAwLCJodHRwOi8vdG9wdGFsLmNvbS9qd3RfY2xhaW1zL2lzX2FkbWluIjp0cnVlLCJjb21wYW55IjoiVG9wdGFsIiwiYXdlc29tZSI6dHJ1ZX0\"\n     },\n     method: \"get\",\n}).then(function(result) {\n     return result.json();\n}).then(function(result) {\n\n}).catch(function(error) {\n\n});",
        "type": "js"
      }
    ],
    "parameter": {
